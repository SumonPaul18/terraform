...
**পদ্ধতি B: ☁️ AWS ক্রেডেনশিয়াল সেটআপ: Shared Credentials File এবং AWS CLI (`aws configure`)


## ☁️ AWS ক্রেডেনশিয়াল সেটআপ: Shared Credentials File এবং AWS CLI (`aws configure`)
...
2.  **AWS CLI ইন্সটল করুন:**
      ...
      * আপনার সিস্টেমে AWS Command Line Interface (CLI) ইন্সটল করা আছে কিনা নিশ্চিত করুন। যদি না থাকে, AWS-এর অফিসিয়াল ডকুমেন্টেশন থেকে ইন্সটল করে নিন।
...
**পদ্ধতি D: IAM Role (Recommended for Production Workloads on EC2/ECS/EKS)**
...
**পদ্ধতি E: হার্ডকোডিং (NOT Recommended for Production)**
